...
**6) Импорт пользователей - импортирует пользователей из архива users**
...
**ПОПРАВИТЬ скрипт можно** - 
'''
после того как вы его подтянули с моего гитхаба, а именно: wget raw.githubusercontent.com/hiyokkoooo/demo25/refs/heads/main/sshusers.sh (НАПРИМЕР)
...
wget raw.githubusercontent.com/hiyokkoooo/demo25/refs/heads/main/sshusers.sh
      ...
      чтоб пофиксить - в /etc/resolv.conf указать nameserver 8.8.8.8 (временно), после настройки dns нужно будет поставить как в исходном мануале.
